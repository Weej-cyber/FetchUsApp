  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '48px 24px', fontFamily: 'Nunito, sans-serif', color: '#2D3436', lineHeight: 1.8 }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <h1 style={{ fontFamily: 'Poppins, sans-serif', color: '#5B4B8A', fontSize: '1.8rem', fontWeight: 700, margin: '0 0 4px' }}>FetchUs Terms of Service</h1>
      ...
      <h2 style={{ fontFamily: 'Poppins, sans-serif', fontSize: '1.1rem', color: '#2D3436', marginTop: 32 }}>5. Liability</h2>
      <p>FetchUs provides a platform for booking pet care services. While we take care in selecting our walkers, FetchUs is not liable for incidents that occur during walks beyond our reasonable control.</p>

      <h2 style={{ fontFamily: 'Poppins, sans-serif', fontSize: '1.1rem', color: '#2D3436', marginTop: 32 }}>6. Contact</h2>
      <p>For questions about these terms, contact us at <a href="mailto:fetchus2022@gmail.com" style={{ color: '#5B4B8A' }}>fetchus2022@gmail.com</a>.</p>
    </div>
  )
}
