  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#FAF8F3', fontFamily: 'Nunito, sans-serif' }}>
      <div style={{ textAlign: 'center', padding: '32px' }}>
        ...
        <button onClick={signOut} style={{ marginTop: '24px', background: 'none', border: 'none', color: '#b2bec3', fontSize: '0.85rem', cursor: 'pointer', fontFamily: 'Nunito' }}>Sign Out</button>
      </div>
    </div>
  )
}
