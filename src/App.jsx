  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#FAF8F3' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ fontFamily: 'Nunito, sans-serif', color: '#5B4B8A', fontWeight: 600 }}>Loading...</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#FAF8F3' }}>
      <div style={{ textAlign: 'center', padding: '32px' }}>
        ...
        <p style={{ fontFamily: 'Nunito, sans-serif', color: '#5B4B8A', fontWeight: 700, fontSize: '1.1rem', marginBottom: '8px' }}>Account not configured</p>
        <p style={{ fontFamily: 'Nunito, sans-serif', color: '#636e72', fontSize: '0.9rem', marginBottom: '24px' }}>{user?.email} is not assigned a role yet.</p>
        <button onClick={signOut} style={{ padding: '12px 24px', borderRadius: '10px', background: '#5B4B8A', color: 'white', border: 'none', fontFamily: 'Nunito', fontWeight: 700, cursor: 'pointer' }}>
          Sign Out
        </button>
      </div>
    </div>
...
function RoleRedirect() {
  ...
  if (!loading && !role) return <NoRoleScreen />
