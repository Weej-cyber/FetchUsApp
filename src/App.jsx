  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#FAF8F3', fontFamily: 'Nunito, sans-serif' }}>
      <div style={{ textAlign: 'center', padding: '32px' }}>
        <div style={{ background: '#5B4B8A', borderRadius: '20px', width: '80px', height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px', fontSize: '2.5rem' }}>🐾</div>
        <h1 style={{ fontFamily: 'Poppins, sans-serif', color: 'white', fontWeight: 800, marginBottom: '8px', background: '#5B4B8A', display: 'inline-block', padding: '4px 18px', borderRadius: '8px' }}>FetchUs</h1>
