  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#FAF8F3', fontFamily: 'Nunito, sans-serif' }}>
      <div style={{ textAlign: 'center', padding: '32px' }}>
        ...
        <h1 style={{ fontFamily: 'Poppins, sans-serif', color: '#5B4B8A', fontWeight: 800, marginBottom: '4px', fontSize: '1.6rem' }}>FetchUs</h1>
        <p style={{ color: '#991B1B', fontWeight: 700, fontSize: '0.78rem', marginBottom: '4px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Dev Mode</p>
        <p style={{ color: '#636e72', marginBottom: '32px', fontSize: '0.9rem' }}>Select a role to bypass auth</p>
...
function LoadingScreen() {
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: '#FAF8F3', fontFamily: 'Nunito, sans-serif', color: '#5B4B8A', fontWeight: 700 }}>
      Loading...
    </div>
  )
}
...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/dev" element={<DevRolePicker />} />
